...
#ifndef TPL_ALGORITHM_PF_H
#define TPL_ALGORITHM_PF_H
...
namespace tpl {
    ...
    class TplChipGridPF : public TplAbstractChipGrid {
        public:
            ///////////////////////// Constructors /////////////////////////////////////////
            //! Default constructor defaulted.
            TplChipGridPF() = default;
            //! Constructor using grid_size, r1 and r2 radius.
            TplChipGridPF(double r1, double r2, unsigned int grid_size);
            //! Destructor defaulted.
            ~TplChipGridPF() = default;
            //! Copy constructor defaulted.
            TplChipGridPF(const TplChipGridPF &rhs) = default;
            //! Assignment operator defaulted.
            TplChipGridPF & operator=(const TplChipGridPF &rhs) = default;
            ///////////////////////// Constructors /////////////////////////////////////////
    ...
    class TplAlgorithmPF : public TplAbstractAlgorithm {
        public:


            //! TplAlgorithmPF constructor.
            TplAlgorithmPF();
