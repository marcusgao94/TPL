...
void STR_add_to_stringtab_Int(void *hdl, const char *str, int inValue) {
    ...
    // need to free this in DFEF_stringhash.cpp
...
void init_symbol_table(void *Keyword_set)
{
    ...
    STR_add_to_stringtab_Int(Keyword_set, "CUTSIZE", K_CUTSIZE) ;
    STR_add_to_stringtab_Int(Keyword_set, "CUTSPACING", K_CUTSPACING) ;
    STR_add_to_stringtab_Int(Keyword_set, "DEFAULTCAP", K_DEFAULTCAP) ;
    STR_add_to_stringtab_Int(Keyword_set, "DESIGN", K_DESIGN) ;
    STR_add_to_stringtab_Int(Keyword_set, "DESIGNRULEWIDTH",
      K_DESIGNRULEWIDTH) ;
    STR_add_to_stringtab_Int(Keyword_set, "DIAGWIDTH", K_DIAGWIDTH) ;
    STR_add_to_stringtab_Int(Keyword_set, "DIEAREA", K_DIEAREA) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "ENCLOSURE", K_ENCLOSURE) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "EXCEPTPGNET", K_EXCEPTPGNET) ;
...
/*    STR_add_to_stringtab_Int(Keyword_set, "", K_END_SNETS) ; */
    ...
    STR_add_to_stringtab_Int(Keyword_set, "FILLWIREOPC", K_FILLWIREOPC) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "GROUNDSENSITIVITY",
      K_GROUNDSENSITIVITY) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "HALO", K_HALO) ;
    STR_add_to_stringtab_Int(Keyword_set, "HARDSPACING", K_HARDSPACING) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "LAYERS", K_LAYERS) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "MINCUTS", K_MINCUTS) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "NETEXPR", K_NETEXPR) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "NONDEFAULTRULE",
      K_NONDEFAULTRULE) ;
    STR_add_to_stringtab_Int(Keyword_set, "NONDEFAULTRULES",
      K_NONDEFAULTRULES) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "OFFSET", K_OFFSET) ;
    STR_add_to_stringtab_Int(Keyword_set, "OPC", K_OPC) ;
    STR_add_to_stringtab_Int(Keyword_set, "ORDERED", K_ORDERED) ;
    STR_add_to_stringtab_Int(Keyword_set, "ORIGIN", K_ORIGIN) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "PARTIAL", K_PARTIAL) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "POLYGON", K_POLYGON) ;
    STR_add_to_stringtab_Int(Keyword_set, "PORT", K_PORT) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "ROUTEHALO", K_ROUTEHALO) ;
    STR_add_to_stringtab_Int(Keyword_set, "ROW", K_ROW) ;
    STR_add_to_stringtab_Int(Keyword_set, "ROWCOL", K_ROWCOL) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "STYLES", K_STYLES) ;
    STR_add_to_stringtab_Int(Keyword_set, "SUBNET", K_SUBNET) ;
    STR_add_to_stringtab_Int(Keyword_set, "SUM", K_SUM) ;
    STR_add_to_stringtab_Int(Keyword_set, "SUPPLYSENSITIVITY",
      K_SUPPLYSENSITIVITY) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "VIA", K_VIA) ;
    STR_add_to_stringtab_Int(Keyword_set, "VIARULE", K_VIARULE) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "WIREEXT", K_WIREEXT) ;
