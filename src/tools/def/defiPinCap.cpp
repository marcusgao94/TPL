...
void defiPinPort::addVia(const char* viaName, int ptX, int ptY) {
...
// 5.7
void defiPin::addVia(const char* viaName, int ptX, int ptY) {
...
// 5.7
void defiPin::addPortVia(const char* via, int viaX, int viaY) {
  int i = this->numPorts_ - 1;
  this->pinPort_[i]->defiPinPort::addVia(via, viaX, viaY);
}
